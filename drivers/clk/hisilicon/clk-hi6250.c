...
static const struct hisi_fixed_rate_clock hi3660_fixed_rate_clks[] = {
        ...
        { HI3660_CLK_PPLL0, "clk_ppll0", NULL, 0, 1440000000, },
        { HI3660_CLK_PPLL1, "clk_ppll1", NULL, 0, 1334000000, },
        { HI3660_CLK_PPLL2, "clk_ppll2", NULL, 0, 1290000000, },
        { HI3660_CLK_PPLL3, "clk_ppll3", NULL, 0, 1600000000, },
       /* { HI3660_CLK_SCPLL, "clk_scpll", NULL, 0, 245760000, },*/ // unknown, not in downstream
        ...
        { HI3660_OSC32K, "osc32k", NULL, 0, 32768, },
        { HI3660_OSC19M, "osc19m", NULL, 0, 19200000, },
       /* { HI3660_CLK_480M, "clk_480m", NULL, 0, 480000000, },*/ // unknown, not in downstream
       /* { HI3660_CLK_INV, "clk_inv", NULL, 0, 10000000, },*/ // unknown, not in downstream
};
